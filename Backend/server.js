                    ...
                    if (message.is_dangerous) {
                        ...
                        try {
                            ...
                            const newAlert = new Alert({
                                ...
                                description: message.description || "Automatic AI Detection: Danger detected.",
                            ...
                            const populatedAlert = await Alert.findById(savedAlert._id).populate('crosswalkId'); 
                            
                            console.log("Alert saved successfully to MongoDB with Cloudinary URL.");
...
// Base Route
app.get("/", (req, res) => {
  res.send("AI Smart Crosswalk Backend is Running with Socket.io & Cloudinary.");
});
